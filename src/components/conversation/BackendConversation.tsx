...
import BackendGenerations from "../project/backend/BackendGenerations";
        ...
        <div className="flex flex-col w-full min-h-[70vh] h-full">
            <Card className="flex flex-col w-full h-full min-h-[70vh] sm:h-4/12 bg-[#1a1d21] border-0 rounded-lg overflow-hidden shadow-lg">
                                        ...
                                        <TooltipTrigger asChild>
                                            ...
                                            >
                                                ...
                                                {isLoadingSubmitConversation ? (
                                                    ...
                                                    <ChevronRightCircle className="h-4 w-4 ml-1" />
                                                )}
                                            </Button>
                                        </TooltipTrigger>
                                        <TooltipContent>
                                            <p>
                                                ...
                                                build your backend service based
                                                on latest conversation between
                                                you and AI Agents
                                            </p>
                                        </TooltipContent>
                                    </Tooltip>
                                </TooltipProvider>
                                <span className="text-[10px] md:text-xs text-subtext-in-dark-bg font-normal text-end">
                                    {
                ...
                <Tabs
                    ...
                    className="flex-1 flex flex-col rounded-lg self-center mt-4"
                >
