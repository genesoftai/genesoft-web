...
import { Loader2, Plus, Trash2, Eye, EyeOff, Save, X, Pencil } from "lucide-react";
                ...
                <div className="mt-6 space-y-6">
                    ...
                    <div className="space-y-4 p-4 border border-line-in-dark-bg rounded-md">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="env-key" className="text-white text-xs">
                                Key
                            </Label>
                            <Input
                                id="env-key"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="env-value" className="text-white text-xs">
                                Value
                            </Label>
                            <Input
                                id="env-value"
                        ...
                        <div className="flex items-center space-x-2">
                            <Switch
                                ...
                                onCheckedChange={(checked: boolean) => setNewEnv({ ...newEnv, isSecret: checked })}
                            />
                            <Label htmlFor="env-secret" className="text-white text-xs">
                    ...
                    <div className="space-y-4">
                        ...
                        {loading && envs.length === 0 ? (
                            ...
                            <p className="text-subtext-in-dark-bg text-sm">No environment variables found.</p>
                        ) : (
                                        ...
                                        >
                                            {editingEnv?.id === env.id ? (
                                                <div className="space-y-3">
                                                    <div className="flex justify-between items-center">
                                                        ...
                                                        <div className="flex space-x-2">
                                                            <Button
                                                                size="sm"
                                                                variant="ghost"
                                                                onClick={() => handleUpdateEnv(editingEnv)}
                                                                disabled={loading}
                                                            >
                                                                {loading ? (
                                                    ...
                                                    <div className="space-y-2">
                                                        <Label htmlFor={`edit-value-${env.id}`} className="text-white text-xs">
                                                            Value
                                                        </Label>
                                                        <Input
                                                    ...
                                                    <div className="flex items-center space-x-2">
                                                        <Switch
                                                            ...
                                                            checked={editingEnv.isSecret}
                                                            onCheckedChange={(checked: boolean) => setEditingEnv({ ...editingEnv, isSecret: checked })}
                                                        />
                                                        <Label htmlFor={`edit-secret-${env.id}`} className="text-white text-xs">
                                                            Secret
                                                        </Label>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    {env.isSecret && (
                                                        <div className="flex items-center space-x-2">
                                                            ...
                                                            <span className="text-xs text-subtext-in-dark-bg">Secret</span>
                                                        </div>
                                                    )}
                                                </div>
                                            )}
