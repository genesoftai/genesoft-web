...
export async function getFigmaFileByProjectId(projectId: string) {
    if (!projectId) {
        throw new Error("Project ID is required");
    }

    const url = `${genesoftCoreApiServiceBaseUrl}/figma/file/project/${projectId}`;
...
export async function updateFigmaFileByProjectId(
    projectId: string,
    fileUrl: string,
) {
    if (!projectId) {
    ...
    try {
        ...
        console.error("Error updating Figma file:", error);
